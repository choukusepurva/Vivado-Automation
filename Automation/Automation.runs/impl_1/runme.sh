...
HD_PWD='/home/vlsidesign22/work/Sem_2/IC_Design/Automation/Automation.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log top_RCA_8_bit.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source top_RCA_8_bit.tcl -notrace
